...
(define flag-for-field
  (lambda proto-and-field
    (match proto-and-field
           ...
           (('tls (or 'cipher-suite 'compress-algo)) "CIPHER_SUITE_SET")
...
(define fieldname
  (lambda proto-and-field
    (match proto-and-field
           ...
           (('tls 'compression-algorithm) 'compress-algo)
           (('tls 'nb-certificates) 'nb-certs)
...
(define field->C
  (lambda proto-and-field
    (match proto-and-field
           ...
           (('tls 'compress-algo)                                            "u.handshake.compress_algorithm")
           (('tls 'nb-certs)                                                 "u.handshake.nb_certs")
