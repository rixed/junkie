...
(define flag-for-field
  (lambda proto-and-field
    (match proto-and-field
           ...
           ((or ('pgsql 'num-rows) ('mysql 'num-rows) ('tns 'num-rows)) "SQL_NB_ROWS")
           ((or ('pgsql 'num-fields) ('mysql 'num-fields) ('tns 'num-fields)) "SQL_NB_FIELDS")
           ...
           (('sip 'session-id) "SIP_SESSIONID_SET")
...
(define fieldname
  (lambda proto-and-field
    (match proto-and-field
           ...
           ((or ('pgsql 'numrows) ('mysql 'numrows) ('tns 'numrows)) 'num-rows)
           ((or ('pgsql 'numfields) ('mysql 'numfields) ('tns 'numfields)) 'num-fields)
           ((or ('pgsql 'num-cols) ('mysql 'num-cols) ('tns 'num-cols)) 'num-fields)
           ((or ('pgsql 'numcols) ('mysql 'numcols) ('tns 'numcols)) 'num-fields)
           ((or ('pgsql 'dbuser) ('mysql 'dbuser) ('tns 'dbuser)) 'user)
           (('tls (or 'compress-algo 'compression-algo)) 'compress-algorithm)
           (('tls 'num-certificates) 'num-certs)
           (('tls 'not-before) 'not-before-0)
           (('tls 'not-after) 'not-after-0)
...
(define field->C
  (lambda proto-and-field
    (match proto-and-field
           ...
           ((or ('pgsql 'num-rows) ('mysql 'num-rows) ('tns 'num-rows))         "u.query.num_rows")
           ((or ('pgsql 'num-fields) ('mysql 'num-fields) ('tns 'num-fields))   "u.query.num_fields")
           ...
           ; then we have a few generic transformation regardless of the proto
           (('tls 'version-min)                                              "version.min")
           (('tls 'version-maj)                                              "version.maj")
           (('tls 'content-type)                                             "content_type")
           (('tls 'cipher-suite)                                             "u.handshake.cipher_suite")
           (('tls 'compress-algorithm)                                       "u.handshake.compress_algorithm")
           (('tls 'num-certs)                                                 "u.handshake.num_certs")
           (('tls 'serial-number-0)                                          "u.handshake.certs[0].serial_number")
           (('tls 'serial-number-1)                                          "u.handshake.certs[1].serial_number")
           (('tls 'serial-number-2)                                          "u.handshake.certs[2].serial_number")
           (('tls 'serial-number-3)                                          "u.handshake.certs[3].serial_number")
           (('tls 'not-before-0)                                             "u.handshake.certs[0].not_before")
           (('tls 'not-before-1)                                             "u.handshake.certs[1].not_before")
           (('tls 'not-before-2)                                             "u.handshake.certs[2].not_before")
           (('tls 'not-before-3)                                             "u.handshake.certs[3].not_before")
           (('tls 'not-after-0)                                              "u.handshake.certs[0].not_after")
           (('tls 'not-after-1)                                              "u.handshake.certs[1].not_after")
           (('tls 'not-after-2)                                              "u.handshake.certs[2].not_after")
           (('tls 'not-after-3)                                              "u.handshake.certs[3].not_after")
           (('tls 'issuer-0)                                                 "u.handshake.certs[0].issuer")
           (('tls 'issuer-1)                                                 "u.handshake.certs[1].issuer")
           (('tls 'issuer-2)                                                 "u.handshake.certs[2].issuer")
           (('tls 'issuer-3)                                                 "u.handshake.certs[3].issuer")
           (('tls 'subject-0)                                                "u.handshake.certs[0].subject")
...
(define field->type
  (lambda proto-and-field
    (match proto-and-field
           ...
           (('sdp 'host) type:ip)
           ((or ('sip 'from) ('sip 'to) ('sip 'call-id) ('sip 'session-id) ('sip 'mime-type)) type:str)
           ...
           (('tls (or 'not-after 'not-after-0 'not-after-1 'not-after-2 'not-after-3)) type:ber-time)
...
(define (well-known-cst? x)
  (match x
         ...
         ('dhcp-inform 8)
         ('tls-no-compress 0) ('tls-deflate 1)
         ('tls-change-cipher 20) ('tls-alert 21) ('tls-handshake 22) ('tls-application-data 23)
         ; too many TLS ciphers, refer to them by number
         (_ #f)))
...
; takes an expression and return a pair (libname . num-regs)
