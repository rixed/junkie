...
(define (getters)
  (letrec ((parser-getters
               ...
               (if (null? names) prevs  ; no more parsers on the table
                 (let* ((name          (car names))
                        ...
                        (parser-getter (list (cons (append mib (list 3 1 1 1 idx)) (lambda () (cons 'octet-string (string->utf8 name))))
                                             (cons (append mib (list 3 1 1 2 idx)) (lambda () (cons 'counter64 (assq-ref stats 'num-frames))))
                                             (cons (append mib (list 3 1 1 3 idx)) (lambda () (cons 'counter64 (assq-ref stats 'num-bytes))))
                                             (cons (append mib (list 3 1 1 4 idx)) (lambda () (cons 'gauge32   (assq-ref stats 'num-parsers)))))))
                   (parser-getters
               ...
               (if (null? names) prevs
                 (let* ((name          (car names))
                        ...
                        (mux-getter    (list (cons (append mib (list 3 2 1 1 idx)) (lambda () (cons 'octet-string (string->utf8 name))))
                                             ...
                                             (cons (append mib (list 3 2 1 3 idx)) (lambda () (cons 'gauge32   (assq-ref stats 'num-max-children))))
                                             (cons (append mib (list 3 2 1 4 idx)) (lambda () (cons 'counter32 (assq-ref stats 'num-infanticide))))
                                             (cons (append mib (list 3 2 1 5 idx)) (lambda () (cons 'counter64 (assq-ref stats 'num-collisions))))
                                             (cons (append mib (list 3 2 1 6 idx)) (lambda () (cons 'counter64 (assq-ref stats 'num-lookups)))))))
                   (muxer-getters
               ...
               (if (null? names) prevs
                 (let* ((name          (car names))
                        ...
                        (source-getter (list (cons (append mib (list 2 1 1 1 idx)) (lambda () (cons 'octet-string (string->utf8 name))))
                                             ...
                                             (cons (append mib (list 2 1 1 4 idx)) (lambda () (cons 'counter64 (assq-ref stats 'num-packets))))
                                             (cons (append mib (list 2 1 1 5 idx)) (lambda () (cons 'counter64 (assq-ref stats 'num-duplicates))))
                                             (cons (append mib (list 2 1 1 6 idx)) (lambda () (cons 'counter64 (assq-ref stats 'num-cap-bytes))))
                                             (cons (append mib (list 2 1 1 7 idx)) (lambda () (cons 'counter64 (assq-ref stats 'num-wire-bytes)))))))
                   (source-getters
               ...
               (if (null? names) prevs
                 (let* ((name          (car names))
                        ...
                        (malloc-getter (list (cons (append mib (list 4 1 1 1 idx)) (lambda () (cons 'octet-string (string->utf8 name))))
                                             ...
                                             (cons (append mib (list 4 1 1 3 idx)) (lambda () (cons 'gauge32   (assq-ref stats 'num-blocks))))
                                             (cons (append mib (list 4 1 1 4 idx)) (lambda () (cons 'counter64 (assq-ref stats 'num-allocs)))))))
                   (malloc-getters
               ...
               (if (null? names) prevs
                 (let* ((name         (car names))
                        ...
                        (array-getter (list (cons (append mib (list 4 3 1 1 idx)) (lambda () (cons 'octet-string (string->utf8 name))))
                                            (cons (append mib (list 4 3 1 2 idx)) (lambda () (cons 'gauge32      (assq-ref stats 'num-used))))
                                            (cons (append mib (list 4 3 1 3 idx)) (lambda () (cons 'gauge32      (assq-ref stats 'num-malloced))))
                                            (cons (append mib (list 4 3 1 4 idx)) (lambda () (cons 'gauge32      (assq-ref stats 'num-holes))))
                                            (cons (append mib (list 4 3 1 5 idx)) (lambda () (cons 'gauge32      (assq-ref stats 'num-chunks))))
    ...
    (let* ((scalars      (list (cons (append mib '(1 1 0)) getoid-version)
                               ...
                               (cons (append mib '(4 4 0)) getoid-malloced-max)
                               (cons (append mib '(4 5 0)) getoid-denied-parsers)))
