...
//           Type Stat Length--- osef---------------
     ...
     {
         .packet = (uint8_t const []) {
//             Quer  Stat  Length----  Chan------  PktN  Wind  NameLenPr-  ExecuteSql------------
               0x03, 0x01, 0x01, 0xc0, 0x00, 0x00, 0x01, 0x00, 0xff, 0xff, 0x0a, 0x00, 0x00, 0x00, 0x00, 0x00,
//             TypeInfo--------------------  Variant---------------------  Lenght----------------  {
               0x63, 0x68, 0x00, 0x00, 0x00, 0x09, 0x04, 0x00, 0x01, 0x32, 0x68, 0x00, 0x00, 0x00,  'e', 0x00,
                'x', 0x00,  'e', 0x00,  'c', 0x00, 0x20, 0x00,  's', 0x00,  'p', 0x00, 0x5f, 0x00,  'T', 0x00,
                'O', 0x00,  'T', 0x00, 0x5f, 0x00,  'O', 0x00,  'L', 0x00, 0x5f, 0x00,  'U', 0x00,  'p', 0x00,
                'd', 0x00,  'a', 0x00,  't', 0x00,  'e', 0x00,  'E', 0x00,  'n', 0x00,  't', 0x00,  'i', 0x00,
                't', 0x00,  'y', 0x00,  'N', 0x00,  'a', 0x00,  'm', 0x00,  'e', 0x00,  'A', 0x00,  'n', 0x00,
                'd', 0x00,  'I', 0x00,  'c', 0x00,  'o', 0x00,  'n', 0x00, 0x20, 0x00, 0x40, 0x00,  'P', 0x00,
               0x31, 0x00, 0x2c, 0x00, 0x20, 0x00, 0x40, 0x00,  'P', 0x00, 0x32, 0x00, 0x2c, 0x00, 0x20, 0x00,
//                                                    }  ----------------  Stat
               0x40, 0x00,  'P', 0x00, 0x33, 0x00, 0x00, 0x00,  'c',  'R', 0x00, 0x00, 0x00, 0x09, 0x04, 0x00,
               0x01, 0x32,  'R', 0x00, 0x00, 0x00, 0x40, 0x00,  'P', 0x00, 0x31, 0x00, 0x20, 0x00,  'n', 0x00,
                'c', 0x00,  'h', 0x00,  'a', 0x00,  'r', 0x00, 0x28, 0x00, 0x33, 0x00, 0x36, 0x00, 0x29, 0x00,
               0x2c, 0x00, 0x40, 0x00,  'P', 0x00, 0x32, 0x00, 0x20, 0x00,  'n', 0x00,  'c', 0x00,  'h', 0x00,
                'a', 0x00,  'r', 0x00, 0x28, 0x00, 0x33, 0x00, 0x31, 0x00, 0x29, 0x00, 0x2c, 0x00, 0x40, 0x00,
                'P', 0x00, 0x33, 0x00, 0x20, 0x00,  'n', 0x00,  'c', 0x00,  'h', 0x00,  'a', 0x00,  'r', 0x00,
               0x28, 0x00, 0x32, 0x00, 0x33, 0x00, 0x29, 0x00, 0x00, 0x00, 0xef,  'H', 0x00, 0x09, 0x04, 0x00,
               0x01, 0x32,  'A', 0x00,  'A', 0x00,  'A', 0x00, 0x35, 0x00,  'A', 0x00,  'A', 0x00, 0x33, 0x00,
                'A', 0x00,  'A', 0x00, 0x31, 0x00,  'A', 0x00,  'A', 0x00,  'A', 0x00, 0x2d, 0x00, 0x34, 0x00,
               0x36, 0x00, 0x34, 0x00, 0x37, 0x00, 0x39, 0x00, 0x35, 0x00,  'A', 0x00,  'A', 0x00, 0x2d, 0x00,
                'A', 0x00,  'A', 0x00, 0x30, 0x00,  'A', 0x00, 0x2d, 0x00,  'A', 0x00, 0x39, 0x00,  'A', 0x00,
               0x31, 0x00, 0x2d, 0x00,  'A', 0x00, 0x32, 0x00, 0x38, 0x00, 0x38, 0x00, 0x00, 0x00, 0xef, 0x3e,
               0x00, 0x09, 0x04, 0x00, 0x01, 0x32, 0x3e, 0x00,  'm', 0x00,  'a', 0x00,  'i', 0x00,  'l', 0x00,
               0x32, 0x00, 0x2e, 0x00,  'a', 0x00,  'd', 0x00,  'm', 0x00,  'i', 0x00,  'n', 0x00, 0x2d, 0x00,
                'a', 0x00,  'd', 0x00,  'm', 0x00,  'i', 0x00,  'n', 0x00,  'i', 0x00,  's', 0x00,  't', 0x00,
                'r', 0x00,  'a', 0x00, 0x2e, 0x00,  'c', 0x00,  'o', 0x00, 0x5f, 0x00,  'A', 0x00,  'B', 0x00,
                'C', 0x00,  'D', 0x00,  'E', 0x00, 0x00, 0x00, 0xef, 0x2e, 0x00, 0x09, 0x04, 0x00, 0x01, 0x32,
               0x2e, 0x00,  'E', 0x00,  'F', 0x00,  'G', 0x00, 0x5f, 0x00,  'P', 0x00,  'R', 0x00,  'O', 0x00,
                'D', 0x00,  'U', 0x00,  'C', 0x00,  'T', 0x00, 0x5f, 0x00,  'F', 0x00,  'G', 0x00,  'H', 0x00,
                'I', 0x00,  'J', 0x00, 0x5f, 0x00,  'p', 0x00, 0x2e, 0x00,  'g', 0x00,  'i', 0x00,  'f', 0x00,
         },
         .size = 0x1c0,
         .cap_len = 0x1b0,
         .ret = PROTO_OK,
         .way = FROM_CLIENT,
         .expected = {
             .info = { .head_len = 0x1c0 - 8, .payload = 0},
             .set_values = SQL_SQL,
             .u = { .query = { .sql = "Sp_ExecuteSql N'exec sp_TOT_OL_UpdateEntityNameAndIcon @P1, @P2, @P3',N'@P1 nchar(36),@P2 nchar(31),@P3 nchar(23)',N'AA5AA3AA1AAA-464795AA-AA0A-A9A1-'," , .truncated = false} },
             .msg_type = SQL_QUERY,
         },
         .called = true,
         .last_pkt_type = TDS_PKT_TYPE_RPC,
