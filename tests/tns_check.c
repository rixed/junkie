...
static struct lookup_query_test {
    uint8_t const *packet;
    int size;
    uint8_t first_char;
    bool expected_chunked;
    bool expected_query;
...

    {
        .packet = (uint8_t const []) {
//                                                        Size
            0x00,0x00,0x00,0x00,0xd4,0xf7,0x05,0x03, 0xfe,0x40, 'c', 'a', 'a', 'a', 'a', 'a',
             'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a',  'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a',
             'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a',  'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a',
             'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a',  'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a',
//                                                             Size
             'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a',  'a', 'a',0x40, 'a', 'a', 'a', 'a', 'a',
        },
        .size = 0x50,
        .expected_query = true,
        .expected_chunked = true,
...
//                      Size
            0x00, 0x01, 0x3a,  'b',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',
             'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',
             'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',
             'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a',  'a', 0x01, 0x00, 0x00,
...

    {
        .packet = (uint8_t const []) {
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xb4, 0x01, 0x00, 0x09, 0x27, 0x00,
            ...
            0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2d, 0x00, 0x01,
            0x00, 0x00, 0x00, 0x00, 0x02, 0x03, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x02, 0x03, 0x00, 0x00, 0x16, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x03, 0x00, 0x00, 0x02,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x2e, 0x00, 0x01, 0x02, 0x00, 0x00, 0x00, 0x07, 0xfd, 0x01, 0x07, 0x77, 0x71, 0x02, 0x04,
            0x07, 0x1b, 0x39, 0x02, 0xc1, 0x05, 0x18, 0x02, 0xc1, 0x36, 0x19, 0x04, 0xc2, 0x09, 0x33, 0x5b,
            0x02, 0x4f, 0x4e
        },
        .size = 0x133,
        .expected_query = false,
...
{
    for (unsigned i = 0; i < NB_ELEMS(lookup_query_tests); ++i) {
        struct lookup_query_test *test = lookup_query_tests + i;
        printf("Check lookup query %d of size 0x%x (%d)\n", i, test->size, test->size);
        struct cursor cursor = { .head = test->packet, .cap_len = test->size };
        struct query_candidate candidate = {.num_candidate_size = 0};
        bool found = lookup_query(&cursor, &candidate);
        CHECK_INT(test->expected_query, found);
        if (found) {
            CHECK_INT(test->expected_chunked, candidate.is_chunked);
            CHECK_INT(test->expected_size, candidate.query_size);
            CHECK_INT(test->first_char, cursor.head[candidate.is_chunked ? 1 : 0]);
        }
    }
}
