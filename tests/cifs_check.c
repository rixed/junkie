...
//          ----
    ...
    {
        .name = "Smb, Session setup response, with security blob",
        .packet = (uint8_t const []) {
            
        },
        .size = 0xf2,
        .ret = PROTO_OK,
        .way = FROM_SERVER,
        .expected = {
            .info = { .head_len = SMB_HEADER_SIZE, .payload = 0xf2 - SMB_HEADER_SIZE },
            .command.smb_command = SMB_COM_SESSION_SETUP_ANDX,
            .tree_id = 0,
            .version = SMB_VERSION_1,
            .ids.multiplex_id = 3,
            .u.connection = {
                .driver = "Windows (TM) Code Name \"Longhorn\" Ultimate 6.0",
                .os = "Windows (TM) Code Name \"Longhorn\" Ultimate 5231",
            },
            .set_values = CIFS_SERVER_OS | CIFS_SERVER_DRIVER,
        }
    },

    {
        .name = "Smb, Session setup response, another one with security blob",
        .packet = (uint8_t const []) {
            ,
            ...
            0x53, 0x00, 0x65, 0x00, 0x72, 0x00, 0x76, 0x00, 0x65, 0x00, 0x72, 0x00, 0x20, 0x00, 0x32, 0x00,
            0x30, 0x00, 0x30, 0x00, 0x33, 0x00, 0x20, 0x00, 0x33, 0x00, 0x37, 0x00, 0x39, 0x00, 0x30, 0x00,
            0x20, 0x00, 0x53, 0x00, 0x65, 0x00, 0x72, 0x00, 0x76, 0x00, 0x69, 0x00, 0x63, 0x00, 0x65, 0x00,
            0x20, 0x00, 0x50, 0x00, 0x61, 0x00, 0x63, 0x00, 0x6b, 0x00, 0x20, 0x00, 0x31, 0x00, 0x00, 0x00,
            0x57, 0x00, 0x69, 0x00, 0x6e, 0x00, 0x64, 0x00, 0x6f, 0x00, 0x77, 0x00, 0x73, 0x00, 0x20, 0x00,
            0x53, 0x00, 0x65, 0x00, 0x72, 0x00, 0x76, 0x00, 0x65, 0x00, 0x72, 0x00, 0x20, 0x00, 0x32, 0x00,
            0x30, 0x00, 0x30, 0x00, 0x33, 0x00, 0x20, 0x00, 0x35, 0x00, 0x2e, 0x00, 0x32, 0x00, 0x00
        },
        .size = 0x14f,
        .ret = PROTO_OK,
        .way = FROM_SERVER,
        .expected = {
            .info = { .head_len = SMB_HEADER_SIZE, .payload = 0x14f - SMB_HEADER_SIZE },
            .command.smb_command = SMB_COM_SESSION_SETUP_ANDX,
            .tree_id = 0xffff,
            .version = SMB_VERSION_1,
            .ids.multiplex_id = 64,
            .u.connection = {
                .driver = "Windows Server 2003 5.2",
...

    {
        ...
        .packet = (uint8_t const []) {
//                                  Cmd   Status----------------  Flag  Flag2-----
            0xff,  'S',  'M',  'B', 0x73, 0x00, 0x00, 0x00, 0x00, 0x08, 0x01, 0xc8, 0x00, 0x00, 0x00, 0x00,
...
//                                  Workgroup
        ...
        .expected = {
            ...
            .version = SMB_VERSION_1,
            .ids.multiplex_id = 2,
            .set_values = CIFS_DOMAIN | CIFS_SERVER_OS | CIFS_SERVER_DRIVER,
            .u.connection = {
                .domain = "WORKGROUP",
                .os = "Windows 8 Pro 9200",
                .driver = "Windows 8 Pro 6.2",
            },
        }
    },
    ...
    {
        .name = "SMB_COM_IOCTL - request",
        .packet = (uint8_t const []) {
            0xff, 0x53, 0x4d, 0x42, 0x27, 0x00, 0x00, 0x00, 0x00, 0x08, 0x03, 0xc8, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x43, 0x79, 0x00, 0x08, 0x0e, 0x00,
            0x03, 0x00, 0x40, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00
        },
        .size = 0x29,
        .ret = PROTO_OK,
        .way = FROM_CLIENT,
        .expected = {
            ...
            .command.smb_command = SMB_COM_IOCTL,
            .set_values = CIFS_FID,
            .status = SMB_STATUS_OK,
            .version = SMB_VERSION_1,
            .fid = 0x4000,
...
//                Padd
...

    {
        ...
        .packet = (uint8_t const []) {
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x43, 0x79, 0x00, 0x08, 0x1b, 0x00,
...
//          Create
    ...
    {
        .name = "Trans2 response, set_file_info",
        .packet = (uint8_t const []) {
            0xff, 0x53, 0x4d, 0x42, 0x32, 0x00, 0x00, 0x00, 0x00, 0x88, 0x03, 0xc8, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0xfa, 0x7a, 0x00, 0x08, 0x0d, 0x00,
            0x00, 0x00, 0x00
        },
        .size = 0x23,
        .ret = PROTO_OK,
    ...
    {
        .name = "Trans2 secondary request",
        .packet = (uint8_t const []) {
            0xff, 0x53, 0x4d, 0x42, 0x33, 0x00, 0x00, 0x00, 0x00, 0x08, 0x03, 0xc8, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0xfa, 0x7a, 0x00, 0x08, 0x8b, 0x00,
//          WCT   TotalParCt  TotaDataCt  ParameteCt  ParameteOf  ParameteDs  DataCount-  DataOffset  Data
            0x09, 0x06, 0x00, 0x0e, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xbe, 0x10, 0x35, 0x00, 0xb8,
//          Disp  FID-------
            0x10, 0xff, 0xff, 0xbe, 0x10, 0x00, 0xac, 0x10, 0x00, 0x00, 0xb0, 0x10, 0x00, 0x00, 0xb4, 0x10,
        },
        .size = 0x10f3,
        .ret = PROTO_OK,
        .way = FROM_CLIENT,
        .expected = {
            .info = { .head_len = SMB_HEADER_SIZE, .payload = 0x10f3 - SMB_HEADER_SIZE },
            .command.smb_command = SMB_COM_TRANSACTION2_SECONDARY,
            .set_values = CIFS_FID,
            .status = SMB_STATUS_OK,
            .fid = 0xffff,
            .version = SMB_VERSION_1,
            .tree_id = 0x0800,
            .meta_write_bytes = 0x10be,
            .ids.multiplex_id = 0x8b,
        },
    },
...

    {
        ...
        .packet = (uint8_t const []) {
            ...
            0x03, 0x02, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        },
        .size = 0x29,
        .ret = PROTO_OK,
        .way = FROM_CLIENT,
...
.u.path = "/tmp/toto",
...

    {
        ...
        .expected = {
            ...
            .status = SMB_STATUS_OK,
            .set_values = CIFS_TRANS2_SUBCMD | CIFS_PATH,
            .u.path = "\\rawopen\\torture_t2open_yes.txt",
            .subcommand = {
...

    {
        ...
        .expected = {
            ...
            .u.path = "\\TOTRootR_SmUranip\\DNBOX\\N^C\\_RESULTAT.CSV",
            .set_values = CIFS_PATH,
...
//                            BC--------
...

    {
        ...
        .packet = (uint8_t const []) {
            ...
            0xb5, 0x06, 0xb1, 0x57, 0x78, 0xc8, 0x00, 0x00, 0x08, 0x08, 0x74, 0x0e, 0x02, 0xf0, 0x87, 0x0c,
...

    {
        ...
        .expected = {
            ...
            .u.path = "AD_13TF12C_PRT222FFF.TXT",
            .set_values = CIFS_TRANS2_SUBCMD | CIFS_PATH,
            .command.smb_command = SMB_COM_TRANSACTION2,
            .status = SMB_STATUS_OK,
            .version = SMB_VERSION_1,
...

    {
        ...
        .expected = {
            ...
            .u.path = "\\aaaaaaISDIR_T\\LeDIRu\\.00000000030\\TmpData\\11111199.txt",
            .set_values = CIFS_PATH,
    ...
    {
        .name = "NT Transact (SMB_NT_TRANSACT_NOTIFY_CHANGE) - response",
        .packet = (uint8_t const []) {
            0xff, 0x53, 0x4d, 0x42, 0xa0, 0x00, 0x00, 0x00, 0x00, 0x98, 0x07, 0xc8, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x78, 0x70, 0x0e, 0x01, 0x90, 0x48, 0x78,
            0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x48, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0x00, 0x00, 0x00,
    ...
    {
        .name = "NT Transact (SMB_NT_TRANSACT_IOCTL) -  response",
        .packet = (uint8_t const []) {
            0xff, 0x53, 0x4d, 0x42, 0xa0, 0x10, 0x00, 0x00, 0xc0, 0x98, 0x07, 0xc8, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0b, 0x88, 0x68, 0x0b, 0x01, 0x38, 0x4b, 0x52,
            0x00, 0x00, 0x00
        },
        .size = 0x23,
        .ret = PROTO_OK,
        ...
        .expected = {
            .info = { .head_len = SMB_HEADER_SIZE, .payload = 0x23 - SMB_HEADER_SIZE },
            .command.smb_command = SMB_COM_NT_TRANSACT,
            .status = SMB_STATUS_INVALID_DEVICE_REQUEST,
            .version = SMB_VERSION_1,
            .tree_id = 0x880b,
            .ids.multiplex_id = 0x524b,
        },
    },
    ...
    {
        .name = "NT Transact (SMB_NT_TRANSACT_QUERY_SECURITY_DESC) -  response",
        .packet = (uint8_t const []) {
            0xff, 0x53, 0x4d, 0x42, 0xa0, 0x22, 0x00, 0x00, 0xc0, 0x98, 0x07, 0xc8, 0x00, 0x00, 0x67, 0xd0,
            0x31, 0x58, 0x63, 0x79, 0xf3, 0xcd, 0x00, 0x00, 0x01, 0x50, 0x38, 0x0c, 0x01, 0x50, 0xc8, 0xe4,
            0x00, 0x00, 0x00
        },
        .size = 0x23,
        .ret = PROTO_OK,
        ...
        .expected = {
            .info = { .head_len = SMB_HEADER_SIZE, .payload = 0x23 - SMB_HEADER_SIZE },
            .command.smb_command = SMB_COM_NT_TRANSACT,
            .status = SMB_STATUS_ACCESS_DENIED,
            .version = SMB_VERSION_1,
            .tree_id = 0x5001,
            .ids.multiplex_id = 0xe4c8,
        },
    },

    {
        .name = "NT Transact (SMB_NT_TRANSACT_SET_SECURITY_DESC) -  request",
        .packet = (uint8_t const []) {
            ,
            ...
            0x21, 0x02, 0x00, 0x00, 0x00, 0x00, 0x24, 0x00, 0xff, 0x01, 0x1f, 0x00, 0x01, 0x05, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x05, 0x15, 0x00, 0x00, 0x00, 0xc9, 0x3e, 0x09, 0xc5, 0xa2, 0xf9, 0x9d, 0x3b,
            0xcb, 0xaa, 0xa4, 0x69, 0xf4, 0x01, 0x00, 0x00, 0x00, 0x00, 0x1c, 0x00, 0x00, 0x00, 0x1f, 0x00,
            0x01, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x20, 0x00, 0x00, 0x00, 0xd2, 0x04, 0x00, 0x00,
            0x38, 0x15, 0x00, 0x00
        },
        .size = 0xf4,
        .ret = PROTO_OK,
        .way = FROM_CLIENT,
        .expected = {
            .info = { .head_len = SMB_HEADER_SIZE, .payload = 0xf4 - SMB_HEADER_SIZE },
            .set_values = CIFS_FID,
            .command.smb_command = SMB_COM_NT_TRANSACT,
            .subcommand = {
                .nt_transact_subcmd = SMB_NT_TRANSACT_SET_SECURITY_DESC,
            },
            .fid = 0x1,
            .status = SMB_STATUS_OK,
            .version = SMB_VERSION_1,
            .tree_id = 0x0800,
            .ids.multiplex_id = 0x02f2,
            .meta_write_bytes = 160,
        },
    },

    {
        .name = "NT Transact (SMB_NT_TRANSACT_SET_SECURITY_DESC) -  response",
        .packet = (uint8_t const []) {
            0xff, 0x53, 0x4d, 0x42, 0xa0, 0x00, 0x00, 0x00, 0x00, 0x88, 0x03, 0xc8, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0xfa, 0x7a, 0x00, 0x08, 0xf2, 0x02,
            0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x48, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0xab
        },
        .size = 0x48,
        .ret = PROTO_OK,
        .way = FROM_SERVER,
...

    {
        ...
        .expected = {
            ...
            .u.path = "\\rawopen\\torture_ntcreatex.txt",
            .command.smb_command = SMB_COM_NT_TRANSACT,
            .subcommand = {
    ...
    {
        .name = "NT Transact (SMB_NT_TRANSACT_CREATE) - response",
        .packet = (uint8_t const []) {
            
        },
        .size = 0xb0,
        .ret = PROTO_OK,
        .way = FROM_SERVER,
        .expected = {
            .info = { .head_len = SMB_HEADER_SIZE, .payload = 0xb0 - SMB_HEADER_SIZE },
            .set_values = CIFS_FID,
            .command.smb_command = SMB_COM_NT_TRANSACT,
            .status = SMB_STATUS_OK,
            .version = SMB_VERSION_1,
    ...
    {
        .name = "Trans request with no subcommand defined",
        .packet = (uint8_t const []) {
            0xff, 0x53, 0x4d, 0x42, 0x25, 0x00, 0x00, 0x00, 0x00, 0x08, 0x03, 0xc8, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0xfa, 0x7a, 0x00, 0x08, 0x05, 0x00,
            0x0e, 0x16, 0x00, 0x00, 0x00, 0x08, 0x00, 0xb6, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x16, 0x00, 0x5a, 0x00, 0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x31, 0x00, 0x00,
            0x5c, 0x00, 0x50, 0x00, 0x49, 0x00, 0x50, 0x00, 0x45, 0x00, 0x5c, 0x00, 0x4c, 0x00, 0x41, 0x00,
            0x4e, 0x00, 0x4d, 0x00, 0x41, 0x00, 0x4e, 0x00, 0x00, 0x00, 0x68, 0x00, 0x57, 0x72, 0x4c, 0x65,
            0x68, 0x44, 0x4f, 0x00, 0x42, 0x31, 0x36, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x80
        },
        .size = 0x70,
        .ret = PROTO_OK,
        .way = FROM_CLIENT,
    ...
    {
        .name = "SMB_COM_OPEN_ANDX, another response",
        .packet = (uint8_t const []) {
            0xff, 0x53, 0x4d, 0x42, 0x2d, 0x00, 0x00, 0x00, 0x00, 0x88, 0x03, 0xc8, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x43, 0x79, 0x00, 0x08, 0xaa, 0x00,
            0x13, 0xff, 0x00, 0x49, 0x00, 0x0f, 0x80, 0x20, 0x00, 0x72, 0x37, 0x7f, 0x43, 0x00, 0x00, 0x00,
            0x00, 0x40, 0x00, 0x00, 0x00, 0x05, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x6f
        },
        .size = 0x49,
        .ret = PROTO_OK,
        .way = FROM_SERVER,
        .expected = {
            .info = { .head_len = SMB_HEADER_SIZE, .payload = 0x49 - SMB_HEADER_SIZE },
            .command.smb_command = SMB_COM_OPEN_ANDX,
            .version = SMB_VERSION_1,
            .set_values = CIFS_FID,
            .fid = 0x800f,
            .tree_id = 0x0800,
            .ids.multiplex_id = 0xaa,
            .meta_read_bytes = 38,
        }
    },

    {
        ...
        .expected = {
            ...
            .version = SMB_VERSION_1,
            .set_values = CIFS_PATH,
            .u.path = "\\abcopen\\abcdefg_open.txt",
            .tree_id = 0x800,
...

    {
        ...
        .expected = {
            ...
            .version = SMB_VERSION_1,
            .set_values = CIFS_PATH,
            .u.path = "\\testsfileinfo\\filename_test.txt",
            .tree_id = 0x800,
...

    {
        ...
        .expected = {
            ...
            .version = SMB_VERSION_1,
            .set_values = CIFS_PATH,
            .u.path = "\\rawopen\\torture_create.txt",
            .tree_id = 0x800,
...

    {
        ...
        .expected = {
            ...
            .version = SMB_VERSION_1,
            .set_values = CIFS_PATH,
            .u.path = "\\rawopen\\testtmp_mknew.txt",
            .tree_id = 0x800,
            .meta_write_bytes = 0x6,
...
//          Wc
...

    {
        ...
        .expected = {
            ...
            .version = SMB_VERSION_1,
            .set_values = CIFS_PATH,
            .u.path = "\\ABCDEFG\\HIPQRSTUVWXY`OX\\VN",
            .tree_id = 0x880b,
    ...
    {
        .name = "Smb2, Session setup request, another NTLMSSP_AUTH",
        .packet = (uint8_t const []) {
            0xfe, 0x53, 0x4d, 0x42, 0x40, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0xff, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x04, 0x00, 0x04, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x19, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x58, 0x00, 0x35, 0x02,
            //                                                          GSS   size------------  Sequ  Size------------
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xa1, 0x82, 0x02, 0x31, 0x30, 0x82, 0x02, 0x2d,
            //          Ch 0  Size  Prim  Size  Valu  Ch 2
            0xa0, 0x03, 0x0a, 0x01, 0x01, 0xa2, 0x82, 0x02, 0x10, 0x04, 0x82, 0x02, 0x0c, 0x4e, 0x54, 0x4c,
            0x4d, 0x53, 0x53, 0x50, 0x00, 0x03, 0x00, 0x00, 0x00, 0x18, 0x00, 0x18, 0x00, 0x86, 0x00, 0x00,
            0x00, 0x5e, 0x01, 0x5e, 0x01, 0x9e, 0x00, 0x00, 0x00, 0x0e, 0x00, 0x0e, 0x00, 0x58, 0x00, 0x00,
            0x00, 0x10, 0x00, 0x10, 0x00, 0x66, 0x00, 0x00, 0x00, 0x10, 0x00, 0x10, 0x00, 0x76, 0x00, 0x00,
            0x00, 0x10, 0x00, 0x10, 0x00, 0xfc, 0x01, 0x00, 0x00, 0x15, 0x82, 0x88, 0xe2, 0x06, 0x01, 0xb1,
            0x1d, 0x00, 0x00, 0x00, 0x0f, 0xc5, 0x64, 0xfd, 0xb1, 0xa4, 0x8f, 0xf6, 0x83, 0xab, 0x87, 0x3e,
            0x48, 0x1f, 0xc8, 0xb0, 0x5c,  'T', 0x00,  'e', 0x00,  's', 0x00,  't', 0x00,  'd', 0x00,  'o',
            0x00,  'm', 0x00,  'T', 0x00,  'e', 0x00,  's', 0x00,  't', 0x00,  'u', 0x00,  's', 0x00,  'e',
            0x00,  'r', 0x00,  'T', 0x00,  'E', 0x00,  'S', 0x00,  'T', 0x00,  'H', 0x00,  'O', 0x00,  'S',
            0x00,  'T', 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
            0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
            0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
            0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
        ...
        .way = FROM_CLIENT,
        .expected = {
            .info = { .head_len = SMB2_HEADER_SIZE, .payload = 0x28d - SMB2_HEADER_SIZE },
            .command.smb2_command = SMB2_COM_SESSION_SETUP,
            .set_values = CIFS_DOMAIN | CIFS_USER | CIFS_HOSTNAME,
            .u.connection = {
                .user = "Testuser",
...

    {
        ...
        .expected = {
            ...
            .status = SMB_STATUS_OK,
            .version = SMB_VERSION_2,
            .u.path = "\\auto-contact.co\\AB\\xyzxyz",
            .tree_id = 0x1,
            .ids.message_id = 0x04,
        }
    },
...
static struct parse_with_netbios_test {
    ...
    {
        .name = "Smb2 chained command with chain offset",
        .packet = (uint8_t const []) {
            
        },
        .size = 0xdd,
        .ret = PROTO_OK,
        .way = FROM_CLIENT,
    ...
    {
        .name = "Smb batch command with andx",
        .packet = (uint8_t const []) {
            0x00, 0x00, 0x00, 0x8f, 0xff, 0x53, 0x4d, 0x42, 0x73, 0x00, 0x00, 0x00, 0x00, 0x18, 0x07, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xfe,
            0x00, 0x00, 0x10, 0x00,
            // Session setup andx request
            0x0d, 0x75, 0x00, 0x52, 0x00, 0x04, 0x11, 0x0a, 0x00, 0x00, 0x00, 0xa0,
            0x09, 0x08, 0x16, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd4, 0x00, 0x00, 0x00, 0x15,
            0x00, 0x00, 0x00,  'T',  'o',  't',  'o',  'f',  'o',  'o',  'b', 0x00,  'f',  'o',  'o',  'b',
            'a',  'a',  'r', 0x00, 0x00, 0x00,
            // Tree connect andx request
            0x04, 0xff, 0x00, 0x8f, 0x00, 0x08, 0x00, 0x18, 0x00, 0x32,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, '\\', '\\',  '1',  '7',  '2',  '.',  '1',
            '0',  '.',  '6',  '.',  '1',  '0',  '0', '\\',  'I',  'P',  'C',  '$', 0x00, 0x3f, 0x3f, 0x3f,
            0x3f, 0x3f, 0x00
        },
        .size = 0x93,
        .ret = PROTO_OK,
        ...
        .expected = {
            {
                .info = { .head_len = SMB_HEADER_SIZE, .payload = 0x32 },
                .command.smb_command = SMB_COM_SESSION_SETUP_ANDX,
                .set_values = CIFS_DOMAIN | CIFS_USER | CIFS_OS | CIFS_DRIVER,
                .u.connection = {
                    .user = "Totofoob",
                    .domain = "foobaar",
                    .os = "",
                ...
                .info = { .head_len = SMB_HEADER_SIZE, .payload = 0x3d },
                .command.smb_command = SMB_COM_TREE_CONNECT_ANDX,
                .set_values = CIFS_TREE,
                .u.path = "\\\\172.10.6.100\\IPC$",
                .status = SMB_STATUS_OK,
                .version = SMB_VERSION_1,
                .ids.multiplex_id = 16,
            },
    ...
    {
        .name = "Session setup andx query, another one",
        .packet = (uint8_t const []) {
            0x00, 0x00, 0x00, 0xe6,
            0xff, 0x53, 0x4d, 0x42, 0x73, 0x00, 0x00, 0x00, 0x00, 0x18, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xfe, 0x00, 0x00, 0x10, 0x00,
            0x0d, 0x75, 0x00, 0x52, 0x00, 0x04, 0x11, 0x0a, 0x00, 0x00, 0x00, 0xa0, 0x09, 0x08, 0x16, 0x01,
            0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd4, 0x00, 0x00, 0x00, 0x15, 0x00, 0x00, 0x00,  'T',
             'o',  't',  'o',  'f',  'o',  'o',  'b', 0x00,  'f',  'o',  'o',  'b',  'a',  'a',  'r', 0x00,
            0x00, 0x00, 0x04, 0xff, 0x00, 0x8f, 0x00, 0x08, 0x00, 0x18, 0x00, 0x32, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x5c, 0x5c, 0x31, 0x37, 0x32, 0x2e, 0x31, 0x36, 0x2e, 0x36, 0x2e,
            0x32, 0x31, 0x30, 0x5c, 0x49, 0x50, 0x43, 0x24, 0x00, 0x3f, 0x3f, 0x3f, 0x3f, 0x3f, 0x00
        },
        .size = 0xea,
        .ret = PROTO_OK,
        .way = FROM_CLIENT,
        ...
        .expected = {
            {
                ...
                .info = { .head_len = SMB_HEADER_SIZE, .payload = 0x94},
                .command.smb_command = SMB_COM_TREE_CONNECT_ANDX,
                .set_values = CIFS_TREE,
                .u.path = "\\\\172.16.6.210\\IPC$",
                .status = SMB_STATUS_OK,
                .version = SMB_VERSION_1,
                .ids.multiplex_id = 16,
            }
    ...
    {
        .name = "At the end of an unknown netbios frame, check we detect the start of the next",
        .packet = (uint8_t const []) {
            // Some previous netbios
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            // First netbios header
            0x00, 0x00, 0x00, 0x71,
            // First smb2 packet
        ...
        .size = (NETBIOS_HEADER_SIZE + 0x71) * 2 + 0x10,
        .ret = PROTO_OK,
        .way = FROM_CLIENT,
        .number_expected = 2,
        .expected = {
        ...
        struct cifs_proto_info const *const expected)
{
    ...
    CHECK_SET_VALUE(info, expected, CIFS_TREE);
    CHECK_SET_VALUE(info, expected, CIFS_TRANSACTION_SUBCMD);
    ...
    if (VALUES_ARE_SET(info, CIFS_DOMAIN))
        CHECK_STR(info->u.connection.domain, expected->u.connection.domain);
    if (VALUES_ARE_SET(info, CIFS_USER))
        CHECK_STR(info->u.connection.user, expected->u.connection.user);

    if (VALUES_ARE_SET(info, CIFS_SERVER_HOSTNAME))
        CHECK_STR(info->u.connection.hostname, expected->u.connection.hostname);
    if (VALUES_ARE_SET(info, CIFS_SERVER_DRIVER))
        CHECK_STR(info->u.connection.driver, expected->u.connection.driver);
    if (VALUES_ARE_SET(info, CIFS_SERVER_OS))
        CHECK_STR(info->u.connection.os, expected->u.connection.os);
    ...
    if (VALUES_ARE_SET(info, CIFS_TREE))
        CHECK_STR(info->u.path, expected->u.path);
...
static void parse_check(void)
{
    ...
    hook_subscriber_ctor(&proto_cifs->hook, &sub, cifs_info_check);
    ...
    hook_subscriber_ctor(&proto_cifs->hook, &sub, cifs_info_with_netbios_check);
...
static void compute_padding_check()
{
    ...
    assert(1 == compute_padding(&cifs_parser, &cursor, 0, 2));
    assert(0 == compute_padding(&cifs_parser, &cursor, 1, 2));
    assert(3 == compute_padding(&cifs_parser, &cursor, 0, 4));
}
