...
//          Create
...

    {
        ...
        .packet = (uint8_t const []) {
            0xff, 0x53, 0x4d, 0x42, 0x75, 0x00, 0x00, 0x00, 0x00, 0x08, 0x03, 0xc8, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xfa, 0x7a, 0x00, 0x08, 0x04, 0x00,
            0x04, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x32, 0x00, 0x00, 0x5c, 0x00, 0x5c, 0x00,
            0x31, 0x00, 0x39, 0x00, 0x32, 0x00, 0x2e, 0x00, 0x31, 0x00, 0x36, 0x00, 0x38, 0x00, 0x2e, 0x00,
            0x31, 0x00, 0x31, 0x00, 0x34, 0x00, 0x2e, 0x00, 0x31, 0x00, 0x32, 0x00, 0x39, 0x00, 0x5c, 0x00,
            0x54, 0x00, 0x45, 0x00, 0x53, 0x00, 0x54, 0x00, 0x00, 0x00, 0x41, 0x3a, 0x00
        },
        .size = 0x5d,
        .ret = PROTO_OK,
        .way = FROM_CLIENT,
        .expected = {
            .info = { .head_len = SMB_HEADER_SIZE, .payload = 0x5d - SMB_HEADER_SIZE },
