...
static struct parse_test {
    ...
    // Kerberos false positive
    {
        .packet = (uint8_t const []) {
            0x00, 0x00, 0x24, 0xd5, 0x24, 0xd5, 0xff, 0x80, 0x23, 0xdd, 0x6e, 0x82, 0x23, 0xd9, 0x30, 0x82,
            0x23, 0xd5, 0xa0, 0x03, 0x02, 0x01, 0x05, 0xa1, 0x03, 0x02, 0x01, 0x0e, 0xa2, 0x07, 0x03, 0x05,
        },
        .size = 0x20,
        .ret = PROTO_PARSE_ERR,
        .way = FROM_SERVER,
