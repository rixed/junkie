...
struct proto {
    ...
    char *stack_name;       ///< Same, for when used in the protocol stack (ie. with '/' stripped of name)
    ...
    enum proto_code {
        ...
        PROTO_CODE_NETBIOS, PROTO_CODE_TLS, PROTO_CODE_ERSPAN,
        PROTO_CODE_SKINNY,
        PROTO_CODE_DISCOVERY, PROTO_CODE_DUMMY, PROTO_CODE_MAX
